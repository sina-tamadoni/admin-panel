...
import { useDeleteSelectedItems } from "../services/mutations";
import AddProductModal from "../components/AddProductModal";
import DeleteAllProductsModal from "../components/DeleteAllProductsModal";
...
function ProductsPage() {
  ...
  const { data, error, isPending } = useGetProducts(page, searchValue);
